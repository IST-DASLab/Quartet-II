...
from models.quantization import QUANTIZER_CLASSES, BACKWARD_SCHEMES
...
def parse_args(base_parser, args, namespace):
    ...
    parser.add_argument("--g-quant", type=str, default="NoQuantizer", choices=QUANTIZER_CLASSES.keys())
    parser.add_argument(
        "--g-quant-kwargs",
        type=json.loads,
        default="{}",
