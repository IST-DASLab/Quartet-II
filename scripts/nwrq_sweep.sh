...
LOG_DIR="/capstor/store/cscs/swissai/a140/codebases/backprop-scaling-laws/logs/slurm/nwrq_sweep"
mkdir -p "$LOG_DIR"
...
QUANT_SETUPS=(
    # Eden
    "128:16:e4m3:eden:0.93:128"
    # SR
    "128:16:e4m3:sr:1.00:1"
)
# <<<<<<<<<
...
sbatch --array=0-${ARRAY_LIMIT} nwrq_node.sh