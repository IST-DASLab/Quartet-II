...
#SBATCH --no-requeue
#SBATCH --output=/capstor/store/cscs/swissai/a140/codebases/backprop-scaling-laws/logs/slurm/nvidia_sweep/sweep-%A_%a.out
#SBATCH --error=/capstor/store/cscs/swissai/a140/codebases/backprop-scaling-laws/logs/slurm/nvidia_sweep/sweep-%A_%a.err
...
# Parse Quant Setup
IFS=":" read -r DISABLE_FORWARD_QUANT DISABLE_BACKWARD_QUANT FOUR_OVER_SIX <<< "$CURRENT_SETUP"
...
# Special
export SPECIAL_SCHEME="nvidia"
export SPECIAL_SCHEME_KWARGS="{\"disable_forward_quant\": ${DISABLE_FORWARD_QUANT}, \"disable_backward_quant\": ${DISABLE_BACKWARD_QUANT}, \"four_over_six\": ${FOUR_OVER_SIX}}"
...
# WandB Prefix
SETUP_STR="${DISABLE_FORWARD_QUANT};${DISABLE_BACKWARD_QUANT}"
