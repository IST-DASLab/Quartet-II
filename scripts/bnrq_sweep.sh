...
LOG_DIR="/capstor/store/cscs/swissai/a140/codebases/backprop-scaling-laws/logs/slurm/bnrq_sweep"
mkdir -p "$LOG_DIR"
...
sbatch --array=0-${ARRAY_LIMIT} bnrq_node.sh