...
#SBATCH --no-requeue
#SBATCH --output=/capstor/store/cscs/swissai/a140/codebases/backprop-scaling-laws/logs/slurm/fq_sweep/fw-sweep-%A_%a.out
#SBATCH --error=/capstor/store/cscs/swissai/a140/codebases/backprop-scaling-laws/logs/slurm/fq_sweep/fw-sweep-%A_%a.err
...
# Parse Quant Setup
IFS=":" read -r HADAMARD_DIM SCALE_OVERRIDE <<< "$CURRENT_SETUP"
...
echo "Quant: Had Dim=${HADAMARD_DIM}, Scale Override=${SCALE_OVERRIDE}"
...
export W_QUANT="QuestNvfp4Quantizer"
export W_BITS=4
export W_QUANT_KWARGS="{\"hadamard_dim\": ${HADAMARD_DIM}, \"scale_override\": ${SCALE_OVERRIDE}}"
export A_QUANT="QuestNvfp4Quantizer"
export A_BITS=4
export A_QUANT_KWARGS="{\"hadamard_dim\": ${HADAMARD_DIM}, \"scale_override\": ${SCALE_OVERRIDE}}"
...
# WandB Prefix
SETUP_STR="${HADAMARD_DIM};${SCALE_OVERRIDE}"
